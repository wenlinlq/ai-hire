...
const initialMessages: Message[] = [
  {
    sender: "ai",
    content:
      "你好！我是你的AI面试助手。今天我们将进行一场模拟面试，帮助你准备真实的面试场景。",
  },
...
function Interview() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    window.setTimeout(() => {
      ...
      setMessages((current) => [
        ...current,
        { sender: "ai", content: getAIResponse(selectedType, content) },
      ]);
    }, 1200);
  };
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <main className="py-12">
        <section className="bg-gradient-to-r from-primary-600 to-primary-500 py-16 text-white">
          <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <h1 className="animate-fade-in-up mb-4 text-4xl font-bold">
              AI模拟面试
            </h1>
            <p
              className="animate-fade-in-up mb-8 text-xl text-primary-100"
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {(Object.keys(typeConfig) as InterviewType[]).map((type) => {
                ...
                return (
                  <div
                    key={type}
                    className={`rounded-xl border border-neutral-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-lg ${selectedType === type ? "ring-2 ring-primary-500 ring-offset-2" : ""}`}
                  >
                    <div
                      className={`mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-xl ${item.color}`}
                    >
                    ...
                    <div className="text-center">
                      <button
                        type="button"
                        className={`rounded-lg px-4 py-2 text-sm text-white transition-colors ${item.button}`}
          ...
          <section className="bg-neutral-50 py-16">
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
              <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm">
                ...
                <div
                  ref={chatRef}
                  className="h-[500px] space-y-6 overflow-y-auto p-6"
                >
                  {messages.map((message, index) => (
                    ...
                    >
                      ...
                      <div
                        className={`max-w-[80%] rounded-lg p-4 ${message.sender === "ai" ? "ml-3 bg-primary-100 text-neutral-800" : "bg-primary-100 text-neutral-800"}`}
                      >
                        <p>{message.content}</p>
                      </div>
                    </div>
                  ...
                  {isTyping && (
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 rounded-lg bg-primary-100 p-4">
                ...
                <div className="border-t border-neutral-200 p-4">
                  <form className="flex" onSubmit={handleSubmit}>
                    ...
                    <button
                      type="submit"
                      className="rounded-r-lg bg-primary-500 px-6 py-3 text-white transition-colors hover:bg-primary-600"
                    >
                      发送
                    </button>
                  </form>
              ...
              <div className="mt-8 flex justify-center space-x-4">
                <button
                  type="button"
                  className="rounded-lg bg-neutral-200 px-6 py-2 text-neutral-700 transition-colors hover:bg-neutral-300"
              ...
              <div className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                <div className="mb-8 grid gap-6 md:grid-cols-4">
                  {[
                    ...
                    ["专业知识", "90", "bg-primary-50 text-primary-600"],
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {feedbackSections.strengths.map((item) => (
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {feedbackSections.improvements.map((item) => (
                        <li key={item} className="text-neutral-600">
                          {item}
                        </li>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="rounded-lg bg-neutral-50 p-4">
                      ...
                      <p className="text-neutral-600">
                        建议从教育背景、工作经验、核心技能和职业目标四个方面进行介绍，控制在
                        1-2 分钟内。
                      </p>
                    </div>
                  </div>
